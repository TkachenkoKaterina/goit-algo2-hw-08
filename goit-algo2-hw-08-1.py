...
class SlidingWindowRateLimiter:
    ...
    def _cleanup_window(self, user_id: str, current_time: float) -> None:
        ...
        # Якщо після очищення deque порожній — видаляємо користувача
        if not window:
    ...
    def time_until_next_allowed(self, user_id: str) -> float:
        ...
        oldest_timestamp = self.message_history[user_id][0]
        remaining = self.window_size - (current_time - oldest_timestamp)
